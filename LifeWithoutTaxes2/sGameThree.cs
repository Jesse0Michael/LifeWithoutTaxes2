...
{
    class sGameThree : interactableScene
    {
        Effect effect1;
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            Street = content.Load<Texture2D>("Texture/DrivingTwoStreet2");
            Sky = content.Load<Texture2D>("Texture/DrivingOneSky21");
            Grass = content.Load<Texture2D>("Texture/DrivingTwoGrass2");
        ...
        public override void Update(GameTime time)
        {
            ...
            //63
            {
                ...
                this.gotoState = stateGame.game4Intro;
                this.endScene = true;
            }
            else
                if (damage >= 10)
                {
                    resetScene();
                    this.sceneControl = sceneControler.goTo;
                    this.gotoState = stateGame.game3Fail;
                    this.endScene = true;
        ...
        public void obstacleManagement(GameTime time)
        {
            ...
            if (obstacleTime.Milliseconds <= 0)
            {
                ...
                obstacleTime = new TimeSpan(0, 0, 0, 0, 500);
            }
        ...
        {
            oTrafficCone = new Obstacle(GraphicsDevice, "Model/TrafficCone", new Vector3(0, 0, -12500), 50.0f, 0.0f, projMatrix, false, false, 50.0f);
            oTrashCan = new Obstacle(GraphicsDevice, "Model/TrashCan", new Vector3(0, 0, -12500), 50.0f, 90.0f, projMatrix, false, false, 50.0f);
            oTire = new Obstacle(GraphicsDevice, "Model/tire", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, false, false, 50.0f);
            oPotHole = new Obstacle(GraphicsDevice, "Model/potHole", new Vector3(0, 0, -12500), 150.0f, 0.0f, projMatrix, false, false, 50.0f);
            oLog = new Obstacle(GraphicsDevice, "Model/Log", new Vector3(0, 0, -12500), 100.0f, 90.0f, projMatrix, false, false, 50.0f);
            oBarricade = new Obstacle(GraphicsDevice, "Model/Barricade", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, false, false, 50.0f);

            oCarBlack = new Obstacle(GraphicsDevice, "Model/carBlack", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
            oCarBlue = new Obstacle(GraphicsDevice, "Model/carBlue", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
            oCarGreen = new Obstacle(GraphicsDevice, "Model/carGreen", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
            oCarPurple = new Obstacle(GraphicsDevice, "Model/carPurple", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
            oCarRed = new Obstacle(GraphicsDevice, "Model/carRed", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
            oCarWhite = new Obstacle(GraphicsDevice, "Model/carWhite", new Vector3(0, 0, -12500), 100.0f, 0.0f, projMatrix, true, false, 50.0f);
