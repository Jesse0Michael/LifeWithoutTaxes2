...
{
    class sGameFourFail : interactableScene
    {
        private objButton conButt;

        public sGameFourFail(mouseHelp mouse, keyboardHelp keyboard, GraphicsDevice GraphicsDevice)
            : base(mouse, keyboard, GraphicsDevice)
        {
            ...
            this.gameObjects.Add(new gameObject(new Vector2(400, 300), "MenuArt/GameFourFail"));
            conButt = new objButton(new Vector2(400, 500), "Retry");
            conButt.zIndex = 0.5f;

            this.gameObjects.Add(conButt);
            this.gameState = stateGame.game4Fail;
