...
namespace LifeWithoutTaxes2
{
    class sGameTwo : interactableScene
    {
        ...
        public override void Update(GameTime time)
        {
            ...
            if ((previousKeyState.IsKeyUp(Keys.Up)) && (keyState.IsKeyDown(Keys.Up)))
            {
                up = true;
                down = false;
                left = false;
            ...
            else if ((previousKeyState.IsKeyUp(Keys.Down)) && (keyState.IsKeyDown(Keys.Down)))
            {
                down = true;
                up = false;
                left = false;
            ...
            else if ((previousKeyState.IsKeyUp(Keys.Right)) && (keyState.IsKeyDown(Keys.Right)))
            {
                right = true;
                down = false;
                up = false;
            ...
            else if ((previousKeyState.IsKeyUp(Keys.Left)) && (keyState.IsKeyDown(Keys.Left)))
            {
                left = true;
                down = false;
                up = false;
