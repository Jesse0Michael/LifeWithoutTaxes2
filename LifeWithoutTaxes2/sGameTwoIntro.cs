...
{
    class sGameTwoIntro : interactableScene
    {
        private objButton conButt;

        public sGameTwoIntro(mouseHelp mouse, keyboardHelp keyboard, GraphicsDevice GraphicsDevice)
            : base(mouse, keyboard, GraphicsDevice)
        {
            ...
            this.gameObjects.Add(new gameObject(new Vector2(400, 300), "MenuArt/GameTwoIntro"));
            conButt = new objButton(new Vector2(400, 515), "Continue");
            conButt.zIndex = 0.5f;

            this.gameObjects.Add(conButt);
            this.gameState = stateGame.game2Intro;
        ...
        public override void Update(GameTime time)
        {
            ...
            if (this.mouse.rect.Intersects(conButt.rect))
            {
                if (this.mouse.mouseDown)
                {
                    ...
                    this.gotoState = stateGame.game2;
                    this.endScene = true;
                }
